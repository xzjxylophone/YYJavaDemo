...
public class Page<T> implements Iterable<T> {
	...
	public Map<String, Object> getGridMap (){
		...
		map.put("current", (getPageNo()<0)? 0 :getPageNo());
		map.put("rowCount", (getPageSize()<0)? 0 :getPageSize());
		map.put("rows", getResult());
		map.put("total", (getTotalItems()<0)?0:getTotalItems());
		return map;
	}
